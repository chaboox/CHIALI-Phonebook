...
import com.adam.annuairechiali.Model.ListCity;
import com.adam.annuairechiali.Model.ListDepartment;
...
*/
    ...
    public static String[] getListMails(){
        Realm realm = Realm.getDefaultInstance();
        RealmResults<Contact> conta;

        conta = realm.where(Contact.class).findAll();
    ...
    public static String[] getListMailsBycompany(String company){
        ...
        conta = realm.where(Contact.class).equalTo("company", company).findAll();
        //String[] mails = new String[conta.size()];
        ArrayList<String> arrayMails = new ArrayList<>();
        int cpt =0;
        for(Contact c : conta){
    ...
    public static String[] getListMailsBycompanyAndDepartement(String company, String departement){
        Realm realm = Realm.getDefaultInstance();
        RealmResults<Contact> conta;

        conta = realm.where(Contact.class).equalTo("company", company).and().equalTo("department", departement).findAll();
        //String[] mails = new String[conta.size()];
        ArrayList<String> arrayMails = new ArrayList<>();
        int cpt =0;
        for(Contact c : conta){
    ...
    public static ArrayList<Contact> getContactsByNameAndFilial(String search, String filial) {
        Realm realm = Realm.getDefaultInstance();
